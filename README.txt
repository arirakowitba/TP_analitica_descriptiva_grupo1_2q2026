...
¿Cómo se relacionan los servicios públicos u otros hitos urbanos en esta distribución de las operaciones?
...
|--------------------------------------------|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Definición del problema                    | 10 de agosto     | Planteo de posibles casos de negocio, preguntas de interes, limitaciones, factor diferencial.                                                                         |
...
| Presentación y 1era entrega                | 7 de septiembre  | Preparación del informe, organización del repositorio, importación de la data a Python                                                                                |
...
| Análisis visual y 2nda entrega             | 5 de octubre     | Preparación del informe, confección de visuales, narración de insights preliminares, comunicación de lo hallado.                                                      |
...
| Algoritmos predictivos y 3era entrega      | 2 de noviembre   | Análisis de similitud y clustering, y otros algoritmos predictivos a fin de entender pesos de variables                                                               |
...
| airbnb_caba_listings            | 11.276    | 287          | Airbnb     | Alq. temp     | Base completa: incluye habitaciones y alojamiento hotelero, y 200 columnas de comodidades |
...
| H3  | La presencia de transporte público se observa en conjunto a un mayor valor de las propiedades de todas las operaciones, a mayor densidad y nivel de servicio.                                                                               | Se medirán distancias a estaciones y densidades, diferenciando entre distintos medios de transporte (MetroBús, Subte, tren)                                                                                |
| H3b | El acceso al transporte público es igualmente valorado por todos los públicos (entre los tres tipos de operación) y por tanto el impacto de la accesibilidad no será significativamente diferente entre ventas, y alquileres de ambos tipos | Se analizará la magnitud del impacto del transporte público para venta, alquiler temporal, y alquiler permanente, y se comparará estadísticamente su impacto sobre los precios en sus respectivas escalas. |
| H4  | La prominencia del alquiler temporal se correlaciona con mayores precios y menor disponibilidad de otras formas de acceso a la vivienda.                                                                                                    | Se comprarán precios de venta y alquiler permanente buscando examinar el impacto de una mayor o menor densidad de alquileres temporales en el precio y la disponibilidad.                                  |
